...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Rent a movie
            int movieId = 1; // Assuming movie with ID 1 is available
            int customerId = 1; // Assuming customer with ID 1 exists
            rentalSystem.rentMovie(movieId, customerId);
            System.out.println("\nMovie rented successfully!");

            // Return a movie
            int rentalId = 1; // Assuming rental with ID 1 exists
            rentalSystem.returnMovie(rentalId);
            System.out.println("Movie returned successfully!");

            // Get rentals by customer
            int customerIdToQuery = 1; // Assuming customer with ID 1 exists
